...
/**
 * Title: Footer 2
 * Slug: chimera-master/footer-2
 * Description: 
 * Categories: chimera-footer
 * Keywords: 
 * Viewport Width: 1280
 * Block Types: 
 * Post Types: 
...
<div class="wp-block-group"><!-- wp:heading {"level":3,"fontSize":"medium","fontFamily":"body"} -->
...
<!-- wp:site-title {"level":0,"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"fontSize":"small"} /--></div>
<!-- /wp:group -->
