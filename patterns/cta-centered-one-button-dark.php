 ...
 * Slug: chimera-master/cta-centered-one-button-dark
 * Description:
	...
	<div class="wp-block-group has-lightest-color has-text-color has-link-color" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<div class="wp-block-group">
			...
			<h2 class="wp-block-heading">
				<strong><?php esc_html_e( 'You want to try Greyd?', 'chimera-master' ); ?></strong>
			</h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center","className":"","fontSize":"medium"} -->
			<p class="has-text-align-center has-medium-font-size"><?php esc_html_e( 'Greyd.Suite is the solution that will remind you how satisfying it is to make a business thrive and scale with WordPress.', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button is-style-prim">
				<a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Download now', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
