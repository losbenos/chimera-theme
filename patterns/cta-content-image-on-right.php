 ...
 * Slug: chimera-master/cta-content-image-on-right
...
<figure class="wp-block-image size-full is-style-default"><img src="http://chimera-theme.local/wp-content/themes/chimera-fse-theme/assets/images/abstract-geometric-art.webp" alt="" style="aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
