...
/**
 * Title: CTA 3
 * Slug: chimera-master/cta-pattern-3
...
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/super-wide.svg","id":617,"dimRatio":70,"overlayColor":"contrast","minHeight":322,"minHeightUnit":"px","align":"full"} -->
<div class="wp-block-cover alignfull" style="min-height:322px"><span aria-hidden="true" class="wp-block-cover__background has-contrast-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-617" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/super-wide.svg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"64px","right":"20px","bottom":"64px","left":"20px"},"blockGap":"36px"}},"layout":{"type":"constrained","contentSize":"1280px","wideSize":"1440px","justifyContent":"center"}} -->
...
<!-- wp:paragraph {"align":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"400","fontSize":"18px"}},"textColor":"primary"} -->
<p class="has-text-align-left has-primary-color has-text-color" style="font-size:18px;font-style:normal;font-weight:400">Contrary to popular belief, Lorem Ipsum is not simply random text.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
