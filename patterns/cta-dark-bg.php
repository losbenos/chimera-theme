 ...
 * Slug: chimera-master/cta-dark-bg
 * Description:
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--background);border-bottom-style:dotted;border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--medium)">
				...
				<p class="has-main-accent-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500"><?php esc_html_e( 'Explore Greyd', 'chimera-master' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-text-align-left has-base-color has-text-color">
					<strong><?php esc_html_e( 'The powerhouse where your business strategy thrives', 'chimera-master' ); ?></strong>
				</h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"align":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"400"}},"textColor":"main-accent","className":""} -->
				<p class="has-text-align-left has-main-accent-color has-text-color" style="font-style:normal;font-weight:400"><?php esc_html_e( 'Benefit from an enhanced Block &amp; Site Editor experience and build beautiful, fast &amp; accessible websites - no coding required.', 'chimera-master' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button has-custom-width wp-block-button__width-100">
					<a class="wp-block-button__link wp-element-button" href="https://greyd.io"><?php esc_html_e( 'Get Started Today →', 'chimera-master' ); ?></a>
				</div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
