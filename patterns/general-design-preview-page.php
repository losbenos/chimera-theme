 ...
 * Slug: chimera-master/general-design-preview-page
 * Description:
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
		...
		<div class="wp-block-group alignwide">
			...
			<p class="has-primary-color has-text-color has-link-color has-small-font-size"><strong><?php esc_html_e( 'Greyd Theme', 'chimera-master' ); ?></strong></p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"className":""} -->
			<h2 class="wp-block-heading"><?php esc_html_e( 'Style Guide', 'chimera-master' ); ?></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->

		<!-- wp:paragraph -->
		<p><?php esc_html_e( 'Build and share your design viewing all affected elements.', 'chimera-master' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
		...
		<div class="wp-block-group alignwide" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small)">
			...
			<p style="font-style:normal;font-weight:700"><?php esc_html_e( 'Colors', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-columns alignwide has-small-font-size" style="padding-bottom:var(--wp--preset--spacing--x-large);font-style:normal;font-weight:700">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<p class="has-text-align-center"><?php esc_html_e( 'Primary Color', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Secondary Color', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Tertiary Color', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-columns alignwide has-small-font-size" style="padding-bottom:var(--wp--preset--spacing--x-large);font-style:normal;font-weight:700">
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Very Dark', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Dark', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Medium Dark', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Medium Light', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Light', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"align":"center"} -->
					<p class="has-text-align-center"><?php esc_html_e( 'Very Light', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large)">
		...
		<div class="wp-block-group alignwide" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small)">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
			<p style="font-style:normal;font-weight:700"><?php esc_html_e( 'Typography', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-columns alignwide" style="padding-bottom:var(--wp--preset--spacing--x-large)">
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<div class="wp-block-group" style="border-bottom-style:none;border-bottom-width:0px">
					...
					<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Heading Font &amp; Sizes', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:group {"layout":{"type":"flex","orientation":"vertical"}} -->
					<div class="wp-block-group">
						<!-- wp:heading {"level":1,"style":{"spacing":{"margin":{"top":"0"}}}} -->
						<h1 class="wp-block-heading" style="margin-top:0"><?php esc_html_e( 'Headline 1', 'chimera-master' ); ?></h1>
						<!-- /wp:heading -->

						<!-- wp:heading -->
						<h2 class="wp-block-heading"><?php esc_html_e( 'Headline 2', 'chimera-master' ); ?></h2>
						<!-- /wp:heading -->

						<!-- wp:heading {"level":3} -->
						<h3 class="wp-block-heading"><?php esc_html_e( 'Headline 3', 'chimera-master' ); ?></h3>
						<!-- /wp:heading -->

						<!-- wp:heading {"level":4} -->
						<h4 class="wp-block-heading"><?php esc_html_e( 'Headline 4', 'chimera-master' ); ?></h4>
						<!-- /wp:heading -->

						<!-- wp:heading {"level":5} -->
						<h5 class="wp-block-heading"><?php esc_html_e( 'Headline 5', 'chimera-master' ); ?></h5>
						<!-- /wp:heading -->

						<!-- wp:heading {"level":6} -->
						<h6 class="wp-block-heading"><?php esc_html_e( 'Headline 6', 'chimera-master' ); ?></h6>
						<!-- /wp:heading -->
					</div>
					<!-- /wp:group -->
				</div>
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<div class="wp-block-group">
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
					<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Body Font &amp; Default Size', 'chimera-master' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:group {"layout":{"type":"constrained"}} -->
					<div class="wp-block-group">
						<!-- wp:paragraph -->
						<p><?php esc_html_e( 'abcdefghijklmnopqrstuvwxyz1234567890', 'chimera-master' ); ?><br><?php esc_html_e( 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'chimera-master' ); ?></p>
						<!-- /wp:paragraph -->
						...
						<div class="wp-block-group gapless-group">
							...
							<p style="font-style:normal;font-weight:100"><?php esc_html_e( '100 - Thin', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"200"}}} -->
							<p style="font-style:normal;font-weight:200"><?php esc_html_e( '200 - Extra Light', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}}} -->
							<p style="font-style:normal;font-weight:300"><?php esc_html_e( '300 - Light', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
							<p style="font-style:normal;font-weight:400"><?php esc_html_e( '400 - Regular', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}}} -->
							<p style="font-style:normal;font-weight:500"><?php esc_html_e( '500 - Medium', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
							<p style="font-style:normal;font-weight:600"><?php esc_html_e( '600 - Semi-Bold', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
							<p style="font-style:normal;font-weight:700"><?php esc_html_e( '700 - Bold', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"800"}}} -->
							<p style="font-style:normal;font-weight:800"><?php esc_html_e( '800 - Extra Bold', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"900"}}} -->
							<p style="font-style:normal;font-weight:900"><?php esc_html_e( '900 - Black', 'chimera-master' ); ?></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->
					</div>
	...
	<div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--x-large);padding-bottom:var(--wp--preset--spacing--x-large)">
		...
		<div class="wp-block-group alignwide" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small)">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
			<p style="font-style:normal;font-weight:700"><?php esc_html_e( 'Buttons &amp; Links', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-buttons alignwide">
			...
			<div class="wp-block-button">
				<a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Primary Button', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->

			<!-- wp:button {"className":"is-style-outline"} -->
			<div class="wp-block-button is-style-outline">
				<a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Secondary Button', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->

			<!-- wp:button {"className":"is-style-alternate"} -->
			<div class="wp-block-button is-style-alternate">
				<a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Tertiary Button', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
		...
		<div class="wp-block-buttons alignwide">
			...
			<div class="wp-block-button is-size-big">
				<a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Large Button', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->

			<!-- wp:button {"className":"is-size-small is-style-outline"} -->
			<div class="wp-block-button is-size-small is-style-outline">
				<a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Small Button', 'chimera-master' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
		...
		<div class="wp-block-group alignwide">
			...
			<p class="has-text-align-left">
				<a href="#"><?php esc_html_e( 'Standard Link', 'chimera-master' ); ?></a>
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	...
	<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--x-large);margin-bottom:var(--wp--preset--spacing--x-large)">
		...
		<div class="wp-block-group alignwide" style="border-bottom-color:var(--wp--preset--color--foreground);border-bottom-style:dotted;border-bottom-width:1px;margin-bottom:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--small)">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}}} -->
			<p style="font-style:normal;font-weight:700"><?php esc_html_e( 'Spacing Sizes', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
			<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Huge', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
			<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Large', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
			<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Medium', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
			<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Small', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group">
			<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"700"}},"fontSize":"tiny"} -->
			<p class="has-tiny-font-size" style="font-style:normal;font-weight:700"><?php esc_html_e( 'Tiny', 'chimera-master' ); ?></p>
			<!-- /wp:paragraph -->
