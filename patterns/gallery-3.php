...
/**
 * Title: Gallery 3
 * Slug: chimera-master/gallery-3
 * Description: Gallery 3
 * Categories: chimera-gallery
 * Keywords: 
 * Viewport Width: 1200
 * Block Types: 
 * Post Types: 
 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"blockGap":"16px","padding":{"top":"0","right":"0","bottom":"0","left":"0"}}},"layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-contrast-color has-text-color" style="font-size:36px;font-style:normal;font-weight:800;line-height:1.3">Gallery</h2>
<!-- /wp:heading -->
...
<div class="wp-block-columns alignwide"><!-- wp:column {"width":"50%","style":{"spacing":{"blockGap":"32px"}}} -->
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"id":461,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/square.svg" alt="" class="wp-image-461"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":466,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/16x9.svg" alt="" class="wp-image-466"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
